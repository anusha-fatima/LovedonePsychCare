// app/e-clinics/page.tsx
"use client";

import { motion } from "framer-motion";
import { Users, MapPin, Video, Heart } from "lucide-react";

export default function EClinicsPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-xl text-muted-taupe/70">
            Bringing mental healthcare to every community across Pakistan
          </p>
        </motion.div>
      </div>
    </div>
