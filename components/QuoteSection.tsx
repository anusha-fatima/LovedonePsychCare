  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(204,219,253,0.95) 0%, rgba(193,211,254,0.95) 50%, rgba(171,196,255,0.95) 100%)",
        }}
      />
        ...
        >
          <div className="inline-flex items-center space-x-3 px-6 py-3 rounded-full bg-white/20 backdrop-blur-md border border-white/30 shadow-lg">
            ...
            <span
              ...
              style={{ color: "rgba(127, 143, 178, 1)" }}
            >
        ...
        >
          <Link href="/psychologists">
            <Button
              size="lg"
              variant="outline"
              className="border-white  hover:bg-white/10 transition-all duration-300"
