    ...
    <section
      ...
      style={{
        background: `linear-gradient(
          135deg,
          rgba(237,242,251,0.95),
          rgba(226,234,252,0.92),
          rgba(204,219,253,0.9)
        )`,
      }}
    >
      ...
      <div
        ...
        style={{ background: "rgb(var(--periwinkle-2))" }}
      />
                        ...
                        <div className="flex flex-wrap gap-2 mb-8">
                          {solution.features.map((feature) => (
                            <span
                              ...
                              style={{
                                background: "rgba(171,196,255,0.15)",
